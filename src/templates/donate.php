...
function donate(): void { ?>
	<section class="donate">
		...
		<a href="https://www.networkforgood.org/donation/ExpressDonation.aspx?ORGID2=91-1996344"><img
				src="networkforgoodlogo.gif" alt="Donate through Network For Good"></a>
	</section>
<?php }